        ...
        for contract_id in self._contract_ids:
            ...
            if is_smart_meter:
                ...
                for device in devices:
                    ...
                    if remote_reading and remote_reading.total_import:   # use total_import as validation that reading is OK
                    ...
                    if localized_today.day == 1:
                        ...
                        if remote_reading and remote_reading.total_import: # use total_import as validation that reading OK
                            daily_readings[device.device_number] += remote_reading.data
                    ...
                    if not future_consumption[device.device_number].future_consumption:
                        if weekly_future_consumption and weekly_future_consumption.future_consumption:
                            ...
                            if two_days_ago_reading and two_days_ago_reading.total_import: # use total_import as validation that reading OK:
